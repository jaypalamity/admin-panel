...
<!--          <li class="dropdown tasks-menu">
		...
		//$result['user_data']['logged_in'];
          ?>
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="assets/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Welcome <?php echo ucfirst($userData['user_data']['first_name']); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
...
<!--              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('index.php/user/profile'); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
