    ...
    <script>
        ...
        $(document).ready(function () {
           ...
           //////////// populating Exam subject on page load /////////////
                  $.ajax({
                    url: '<?php echo base_url('examsubjectchapter/getData'); ?>',
                    dataType: 'html',
                    type: 'POST',
                 ...
                 //////////// populating Exam subject on page load /////////////
            $('.examsubjectchapter').change(function () {
                alert('hi');
                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <?php } ?>
                                    ...
                                    <div class="col-sm-3">                                                                                    
                                        <select class="form-control examsubjectchapter" name="exam_category" id="exam_category" required>
                                    ...
                                    <label for="exam_category" class="col-sm-2 control-label ">Select Subject</label>
                                    
                                    <div class="col-sm-3">                                                                                    
                                        <select class="form-control examsubjectchapter" name="exam_subject" id="exam_subject" required>
...
<!--                                <div class="box-tools">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <form name="exam_subject_level_update" method="post" action="<?php echo base_url('examsubjectchapter/chapterlevelupdate'); ?>" onsubmit="return doconfirm();">
                                <div id="result"> 
                                    
                                </div>
                                    <div class="input-group-btn" id="subjectlevelupdate" style="display:none; text-align: center; margin-bottom: 10px;width: 100%;float: left;">
